                ...
                <div class="main-content">
                    ...
                    <div class="CDN_up">
                        ...
                        <!-- <div class="hidden" style="display: none;"> -->
                            <!-- 静态加速 -->
                            <div class="class-item class-i-active">
                                <iframe src="../CDN加速/static_speedup.html" width="100%" height="1499px"
                                    frameborder="0"></iframe>
                            </div>
                            <!-- 下载加速 -->
                            <div class="class-item class-i-active">
                                <iframe src="../CDN加速/download_speedup.html" width="100%" height="1774px"
                                    frameborder="0"></iframe>
                            </div>
                            <!-- 动态加速 -->
                            <div class="class-item class-i-active">
                                <iframe src="../CDN加速/dynamic_speedup.html" width="100%" height="1605px"
                                    frameborder="0"></iframe>
                            </div>
                            <!-- 点播加速 -->
                            <div class="class-item class-i-active">
                                <iframe src="../CDN加速/demand_speedup.html" width="100%" height="1640px"
                                    frameborder="0"></iframe>
                            </div>
                            <!-- 直播加速 -->
                            <div class="class-item class-i-active">
                                <iframe src="../CDN加速/live_speedup.html" width="100%" height="1698.19px"
                                    frameborder="0"></iframe>
                            </div>
                        <!-- </div> -->
                    </div>
