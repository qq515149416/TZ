...
class IpsRequest extends FormRequest
{
    ...
    {   
        ...
        if($array_path[$count_path-1] == 'insert'){
            return [    
                ...
                'ip_company' => 'required|integer|min:0|max:3',
            ...
            return [
                ...
                'ip_company' => 'sometimes|integer|min:0|max:3',
    ...
    public function messages()
    {
        ...
        return  [
            ...
            'ip_company.integer' => 'IP所属运营商的编号必须是0~3的正整数',
            'ip_company.min' => 'IP所属运营商的编号必须是0~3的正整数',
            'ip_company.max' => 'IP所属运营商的编号必须是0~3的正整数',
