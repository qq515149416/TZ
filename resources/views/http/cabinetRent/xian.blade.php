            ...
            <div id="carousel-album" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                    <div class="item active">
                        <img src="{{ asset("/images/cabinetRent/xian/room-photo-1.jpg") }}" alt="陕西西安机房照片1"/>
                        <div class="mask"></div>
                    </div>
                    <div class="item">
                        <img src="{{ asset("/images/cabinetRent/xian/room-photo-2.jpg") }}" alt="陕西西安机房照片2"/>
                        <div class="mask"></div>
                    </div>
                    <div class="item">
                        <img src="{{ asset("/images/cabinetRent/xian/room-photo-3.jpg") }}" alt="陕西西安机房照片3"/>
                        <div class="mask"></div>
                    </div>
                </div>
            </div>
