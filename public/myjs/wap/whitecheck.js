...
function loadWhiteDataGri () {
	//表头
	var dataFiles = ["domain","dxip",["id","cusid","masid","cname","mname"]];
	//行内按钮
	var clickbutton = "";
	//格式化字段addtype
	var formatFileds = {"addtype":"0-业务,1-个人"};
	//分页配置
	var pageEvent = {"action":'/members/searchWhiteList.action?goto=json'};
...
function gj () {
	...
	var params = {"domain":domain,"goto":"json"};
