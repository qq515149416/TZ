...
@section('title', '金融云解决方案-微金融解决方案-金融CDN加速[腾正科技]')

@section('keywords', '金融云解决方案，金融云架构部署，金融高防服务器,微金融解决方案，金融CDN加速')

@section('description', '腾正科技专业为银行、证券、P2P、小贷、典当、众筹等金融企业提供个性化定制的高防御、智能CDN加速金融云解决方案，一站式解决金融行业互联互通、海量访问、数据安全、网页加速、成本高等问题。')
                ...
                <div class="cont">
                    ...
                    <div>
                        <p class="desc" style="color: #fff;">
                            金融云微金融解决方案为银行、证券、P2P、小贷、典当、担保、众筹等小微金融企业提供定制个性化的云计算服务。互联网微金融用户也能享有金融级的安全保障；海量计算、弹性部署能解决互联网业务
                            <br/>
                ...
                <div class="cont">
                    <div class="column">
                        <div class="item">
                            ...
                            <div class="item-body">
                                <p>
                                    腾正科技与金盾联合打造双重防火墙设计，有效对抗DDOS攻击，CC攻击，WAF攻击等。
                                </p>
                            </div>
                        </div>
                        <div class="item">
                            ...
                            <div class="item-body">
                                <p>
                                    采用智能分发平台，按照近源防护原则，提升网站数据加载和传输速度，减少单点防护的压力，更好的保证了防护效果和网民体验度。
                                </p>
                            </div>
                        </div>
                        <div class="item">
                            ...
                            <div class="item-body">
                                <p>
                                    腾正科技为金融云用户提供BGP多线专线线路，由网络上的骨干路由器根据路由跳数与其它技术指标来确定的最佳访问路由，不占用服务器的任何系统资源，能真正实现高速的单IP访问。
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="column">
                        <div class="item">
                            ...
                            <div class="item-body">
                                <p>
                                    腾正科技服务器基于集群技术，实现多节点共同参与计算，自动并行处理并负载均衡，轻松应对硬件故障问题。
                                </p>
                            </div>
                        </div>
                        <div class="item">
                            ...
                            <div class="item-body">
                                <p>
                                    10T+防御带宽，配备T量级超强硬件清洗平台，高达480G的防御能力，独立过滤CC的功能，可满足金融行业对网络安全方面的需求。
                                </p>
                            </div>
                        </div>
                        <div class="item">
                            ...
                            <div class="item-body">
                                <p>
                                    随着机房的扩容以及业务的不断增加，信息管理系统的操作也随之变得更加复杂。腾正科技为用户研发了灵活易用的用户管理中心，让用户简单便捷灵活地管理自己业务。
                                </p>
                            </div>
                        </div>
                    </div>
