		...
		<div class="tz-container clear">
			...
			<div class="main-content">
					...
					<div class="slideshow" id="slideshow">
						<ul class="slideshow-ul clear">
							<li class="slideshow-li clear">
								<div class="slideshow-li-i clear">
					...
					<div class="slideshow-a">
						<ul class="slideshow-ul-a clear">
							<li class="slideshow-li-a clear">
								<div class="slideshow-li-a-i clear">
					...
					<div class="server-support">
						<div class="title">
							<p style="color: #fff !important;">服务器支持PK</p>
					...
					<!-- 托管流程 -->
					<div class="compouter-advantage" style="z-index: -1; background-image: url( {{ asset("/images/wap/托管流程.png") }} );  ">
					...
					<!-- <div class="solutions-consulting">
						<img src="{{ asset("/images/wap/服务器托管蓝条.png") }}" alt="">
						<a>
							立即咨询
						</a>
					</div> -->
