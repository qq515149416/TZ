...
class RusteeshipServerController extends Controller
{
    use ModelForm;
    ...
    public function edit($id)
    {
        return Admin::content(function (Content $content) use ($id) {
            ...
            $content->header('托管管理');
            $content->description('托管编辑');
            $content->body($this->form()->edit($id));
        });
    }
    protected function detail($id)
    {
        return Admin::show(RusteeshipServerModel::findOrFail($id), function (Show $show) {
    ...
    {
        return Admin::grid(RusteeshipServerModel::class, function (Grid $grid) {
    ...
    {
        return Admin::form(RusteeshipServerModel::class, function (Form $form) {

            $form->display('id', 'ID');
            $form->text('current', '电流');
