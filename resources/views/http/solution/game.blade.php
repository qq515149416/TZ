                ...
                <div class="cont">
                    <div class="column">
                        <div class="item">
                            ...
                            <div class="item-body">
                                <p>
                                    10T+防御带宽，配备T量级超强硬件清洗平台，抵御不同类型DDoS、CC等攻击坚如磐石，满足游戏客户对网络安全方面的需求。
                                </p>
                            </div>
                        </div>
                        <div class="item">
                        ...
                        <div class="item">
                            ...
                            <div class="item-body">
                                <p>
                                    游戏云专属服务器集群，高IO读写性能。保证在高并发下依然能够保证稳定的IOPS，有效避免了游戏卡顿现象，提升玩家体验以及留存率。
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="column">
                        ...
                        <div class="item">
                            ...
                            <div class="item-body">
                                <p>
                                    游戏运营过程中，可以根据用户量随时增加或者合并服务器，利用负载均衡，自动分配用户流量，满足服务器平滑扩展需求。
                                </p>
                            </div>
                        </div>
                        <div class="item">
