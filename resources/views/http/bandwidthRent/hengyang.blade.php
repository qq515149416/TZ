...
@section('title', '衡阳带宽租用-独享带宽租用-大带宽租用-服务器带宽价格[腾正科技]')

@section('keywords', '衡阳带宽租用，独享带宽租用，大带宽租用，服务器带宽价格，G口带宽租用')

@section('description', '腾正自主衡阳T3级机房，T级集群防火墙，高质量G口、万兆大带宽资源接入，提供安全可靠价格优惠的百M、千兆、万兆、G口大带宽租用及独享带宽租用服务，咨询热线0769-22226555')

@section('content')
<div class="tz-bandwidth-rent" id="hengyang-bandwidth">
    <!--banner-->
    <div class="banner">
        <div class="cont">
            <div class="title">
        ...
        <div class="tab">
            ...
            <a class="tab-item active" href="/bandwidth-rent/hengyang">衡阳带宽租用</a>
            <a class="tab-item" href="/bandwidth-rent/xian">西安带宽租用</a>
        </div>
    </div>
    <!--机房-->
            ...
            <div id="carousel-album" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                    <div class="item active">
                        <img src="{{ asset("/images/bandwidthRent/hengyang/room-photo-1.jpg") }}" alt="湖南衡阳机房照片1"/>
                        <div class="mask"></div>
                    </div>
                    <div class="item">
                        <img src="{{ asset("/images/bandwidthRent/hengyang/room-photo-2.jpg") }}" alt="湖南衡阳机房照片2"/>
                        <div class="mask"></div>
                    </div>
                    <div class="item">
                        <img src="{{ asset("/images/bandwidthRent/hengyang/room-photo-3.jpg") }}" alt="湖南衡阳机房照片3"/>
                        <div class="mask"></div>
                    </div>
                </div>
            </div>
