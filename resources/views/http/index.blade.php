                        ...
                        <div class="body">
                            <div class="product-item">
                                ...
                                <div class="product-item-option">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <span class="option-btn small" data-url="/zuyong/index">华东</span>
                                        </div>
                                        <div class="col-md-3">
                            ...
                            <div class="product-item">
                                ...
                                <div class="product-item-option">
                                    <div class="row">
                                        <div class="col-md-3">
                                            <span class="option-btn small" data-url="/zuyong/index">BGP</span>
                                        </div>
                                        <div class="col-md-3">
                                            <span class="option-btn small" data-url="/zuyong/dianxin/hunan">单 线</span>
                                        </div>
                                        <div class="col-md-3">
                                            <span class="option-btn small" data-url="/zuyong/shuangxian/hunan">双 线</span>
                                        </div>
                                        <div class="col-md-3">
                                            <span class="option-btn small" data-url="/zuyong/sanxian/hunan">三 线</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-3">
                                    <div class="solution-item">
                                        ...
                                        <div class="solution-item-content">
                                            <h3>金融解决方案</h3>
                                            <p>
                                            金融行业网站对金融企业有着举足轻重的作用，攻击多，网页打开速度慢，用户体验下降等是目前金融行业网站的通病。腾正科技根据金融行业的业务特点，为银行、证券、P2P、小贷、典当、担保、众筹等小微金融企业提供个性化定制高防系列解决方案，解决金融行业互联互通、海量访问、数据安全等问题，同时降低企业投入及运维成本
                                            </p>
                                            <div class="solution-item-button">
